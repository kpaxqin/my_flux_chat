...
(function(window){
    ...
    * */
    Fluxify.setActionTypes = function(types){
        ACTION_TYPES = Object.assign(ACTION_TYPES, Fluxify.utils.keyMirror(types));
    ...
    * */
    ...
    Fluxify.createStore = function(name, methods){
        var Store = Object.assign({}, Fluxify.Events, methods);

        var dispatcher = Fluxify.dispatcher;

        Store.registerDispatchFn = function(callback){
